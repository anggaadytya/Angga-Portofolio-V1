...
const AboutPage = () => {
  return (
    <>
    <Helmet>
      <title>About - Angga Adytya</title>
      <meta name="description" content="About Angga Adytya" />
      ...
      >
        <div className="mx-6">
          ...
          <p className="p-text pt-3 text-justify leading-loose tracking-wide">
            ...
            with a specific focus on FrontEnd Development. I have completed
            several website projects that demonstrate my dedication and
            expertise. I have a strong interest in continuously expanding my
            knowledge in various aspects of web development, and I am ready to
            take on new challenges in the world of technology. I believe that
            the combination of my educational background in information
            technology and practical experience in website development enables
            me to make valuable contributions to future projects. I am eager to
            continue learning and growing in the world of web development, and I
            am prepared to take my skills and dedication to the next level
          </p>
